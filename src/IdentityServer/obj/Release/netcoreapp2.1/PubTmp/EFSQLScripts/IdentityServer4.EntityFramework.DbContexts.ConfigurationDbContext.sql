...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20181230131608_InitialIdentityServerConfigurationDbMigration')
BEGIN
...
BEGIN
    ...
    VALUES (N'20181230131608_InitialIdentityServerConfigurationDbMigration', N'2.1.4-rtm-31024');
END;
